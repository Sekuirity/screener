...
def print_oi(num,step,nearest,url):
    ...
    print("Strike-------------OI-----------Volume------------------OI-------Volume-------OI Diff-------Volume Diff")
...
if __name__ == "__main__":
    ...
    '''
    if __name__ == "__main__":
        nifty_diff, banknifty_diff, nifty_vol_diff, banknifty_vol_diff  = run_script()
        print(f"Nifty OI Difference: {nifty_diff}, Bank Nifty OI Difference: {banknifty_diff}", flush=True)
        print(f"Nifty Vol Difference: {nifty_vol_diff}, BankNifty Vol Difference: {banknifty_vol_diff}", flush=True)
    '''