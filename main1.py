...
def run_script():
    ...
    return nifty_oi_difference, banknifty_oi_difference

if __name__ == "__main__":
    nifty_diff, banknifty_diff = run_script()
    print(f"Nifty OI Difference: {nifty_diff}, Bank Nifty OI Difference: {banknifty_diff}")
